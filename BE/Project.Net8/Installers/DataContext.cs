...
namespace Project.Net8.Installers
{
    public class DataContext
    {
        ...
        private readonly IMongoCollection<NguoiMuaModel> _nguoiMua;
        ...
        public DataContext(IConfiguration configuration)
        {
            ...
            if (client != null)
            {
                ...
                _nguoiMua = _context.GetCollection<NguoiMuaModel>(DefaultNameCollection.NGUOIMUA);
        ...
        public IMongoCollection<NguoiMuaModel> NGUOIMUA { get => _nguoiMua; }
